 ...
 * @author dell
 */
public class PayBil extends JFrame implements ActionListener{
    JButton pay,back;
    Choice cmonth;
    String meter;
    ...
    PayBil(String meter) {
        ...
        JLabel heading = new JLabel("Your Bill");
            ...
            public void itemStateChanged(ItemEvent ae) {
                try {
                    ...
                    if(rs.next()){
                        ...
                        labelunits.setText("N/A");
                        labeltotalbill.setText("N/A");
                        labelstatus.setText("N/A"); 
                    }
